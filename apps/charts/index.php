...
if($db_config['DB_type'] =="mysql"){
  ...
  UNION ALL  select '02' AS 'month' UNION ALL select '03'AS 'month' UNION ALL select '04' AS 'month'
   UNION ALL select '05' AS 'month' UNION ALL select '06' AS 'month' UNION ALL select '07' AS 'month'
   UNION ALL select '08' AS 'month' UNION ALL select '09' AS 'month' UNION ALL select '10' AS 'month'
   UNION ALL select '11'AS  'month'  UNION ALL select '12' AS 'month' ) allm
   left outer join (
